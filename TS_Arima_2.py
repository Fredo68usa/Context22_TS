...
series = read_csv(wd + 'TS_Query_1.'+case+'.csv', index_col=1, parse_dates=[1],usecols = ['Timestamp','Records Affected'], date_parser=parser)
...
pyplot.show()
pyplot.savefig('Predictions'+case+'.png')
